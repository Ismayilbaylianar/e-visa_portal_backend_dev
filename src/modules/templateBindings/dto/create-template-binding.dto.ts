...
export class CreateTemplateBindingDto {
  ...
  // `processingTimeMax` are no longer part of the binding. The per-
  // nationality bulk-upsert endpoint carries `processingDays` and
  // `expeditedProcessingDays` on each `BindingNationalityFee` row.
}
